...
#define K_PORT_OFFSET           10000
#define K_PORT_OPEN_PARKING     K_PORT_OFFSET + 0
#define K_PORT_PARKED_CARS      K_PORT_OFFSET + 1
#define K_PORT_SUSP_ACTIVITY    K_PORT_OFFSET + 2
