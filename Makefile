...
open_parking: db_utils.o common.o ip.o open_parking.o
	g++ `pkg-config --cflags opencv` `pkg-config --libs opencv` `mysql_config --cflags --libs` open_parking.o ip.o db_utils.o common.o -o open_parking -L /usr/lib/mysql -lmysqlclient
