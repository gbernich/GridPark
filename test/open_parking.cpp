...
{  
  ...
  sumsLeft = GetSlidingEdges(edges, startWin, endWin, 0.2, K_LEFT_EDGE);
  sumsRight = GetSlidingEdges(edges, startWin, endWin, 0.2, K_RIGHT_EDGE);
  ...
  WriteSlidingWindow("../../matlab/edges.txt", argv[1], sums, 5);
  WriteSlidingWindow("../../matlab/edges_left.txt", argv[1], sumsLeft, 5);
  WriteSlidingWindow("../../matlab/edges_right.txt", argv[1], sumsRight, 5);
